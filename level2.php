...
echo "<form name=\"form\" method=\"post\" action=\"search_fraction_id_level_great.php\">";
echo "城鎮：
...
//echo "城鎮：<input type=\"text\" style=\"padding:10px\" name=\"town\"  /><br/>";
echo "關卡：
...
//echo "關卡：<input type=\"text\" style=\"padding:10px\" name=\"level\"  /><br/>";?></br><hr color='#000000'></br><?php
